import { getCurrentInstance, version, defineComponent, h, inject, computed, unref, Suspense, nextTick, Transition, provide, reactive, ref, resolveComponent, shallowRef, useSSRContext, createApp, toRef, isRef, defineAsyncComponent, onErrorCaptured, withCtx, createVNode } from 'file:///Users/guillaumequet/code/perso/test/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/guillaumequet/code/perso/test/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///Users/guillaumequet/code/perso/test/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///Users/guillaumequet/code/perso/test/node_modules/unctx/dist/index.mjs';
import { hasProtocol, isEqual, parseURL, joinURL } from 'file:///Users/guillaumequet/code/perso/test/node_modules/ufo/dist/index.mjs';
import { createError as createError$1, sendRedirect } from 'file:///Users/guillaumequet/code/perso/test/node_modules/h3/dist/index.mjs';
import { useHead, createHead as createHead$1 } from 'file:///Users/guillaumequet/code/perso/test/node_modules/@unhead/vue/dist/index.mjs';
import { renderDOMHead, debouncedRenderDOMHead } from 'file:///Users/guillaumequet/code/perso/test/node_modules/@unhead/dom/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter } from 'file:///Users/guillaumequet/code/perso/test/node_modules/vue-router/dist/vue-router.node.mjs';
import { ssrRenderSuspense, ssrRenderComponent } from 'file:///Users/guillaumequet/code/perso/test/node_modules/vue/server-renderer/index.mjs';
...
const node_modules_nuxt_dist_head_runtime_lib_vueuse_head_plugin_mjs_D7WGfuP1A0 = defineNuxtPlugin((nuxtApp) => {
  ...
  nuxtApp._useHead = useHead;
  {
    nuxtApp.ssrContext.renderMeta = async () => {
      const { renderSSRHead } = await import('file:///Users/guillaumequet/code/perso/test/node_modules/@unhead/ssr/dist/index.mjs');
...
const _routes = [
  {
    ...
    file: "/Users/guillaumequet/code/perso/test/pages/about/index.vue",
    children: [],
    meta: __nuxt_page_meta$2,
    alias: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.alias) || [],
    redirect: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.redirect) || void 0,
    component: () => import('./_nuxt/index.4d59913e.mjs').then((m) => m.default || m)
  },
  {
    name: (_c = __nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) != null ? _c : "about-test",
    path: (_d = __nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) != null ? _d : "/about/test",
    file: "/Users/guillaumequet/code/perso/test/pages/about/test.vue",
    children: [],
    meta: __nuxt_page_meta$1,
    alias: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.alias) || [],
    redirect: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.redirect) || void 0,
    component: () => import('./_nuxt/test.372b86ee.mjs').then((m) => m.default || m)
  },
  {
    ...
    file: "/Users/guillaumequet/code/perso/test/pages/index.vue",
    children: [],
    meta: __nuxt_page_meta,
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/index.18af2284.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default.0ebf8e4c.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.c92cbaa3.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
