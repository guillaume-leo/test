...
import { existsSync, realpathSync, promises, statSync as statSync$1 } from 'node:fs';
import 'node:path';
import { builtinModules } from 'node:module';
import { pathToFileURL, fileURLToPath as fileURLToPath$1 } from 'node:url';
import { j as joinURL } from '../shared/nuxi.af709901.mjs';
import { fileURLToPath as fileURLToPath$2, pathToFileURL as pathToFileURL$1, URL as URL$1 } from 'url';
import require$$0$2, { statSync, Stats } from 'fs';
import require$$0$1 from 'path';
import 'module';
import require$$0 from 'assert';
import { format, inspect } from 'util';
import { i as isAbsolute, r as resolve, j as join } from '../shared/nuxi.a2d9d2e1.mjs';
import { g as getPackageManager, p as packageManagerLocks } from '../shared/nuxi.24a0f992.mjs';
import { r as rmRecursive, t as touchFile } from '../shared/nuxi.74850c25.mjs';
import { c as cleanupNuxtDirs, n as nuxtVersionToGitIdentifier } from '../shared/nuxi.8adf0664.mjs';
...
function emitFolderMapDeprecation(match, pjsonUrl, isExports, base) {
  ...
  process.emitWarning(
    `Use of deprecated folder mapping "${match}" in the ${isExports ? '"exports"' : '"imports"'} field module resolution of the package at ${pjsonPath}${base ? ` imported from ${fileURLToPath$2(base)}` : ""}.
...
function legacyMainResolve(packageJsonUrl, packageConfig, base) {
  ...
  throw new ERR_MODULE_NOT_FOUND(
    fileURLToPath$2(new URL(".", packageJsonUrl)),
...
function throwImportNotDefined(specifier, packageJsonUrl, base) {
  throw new ERR_PACKAGE_IMPORT_NOT_DEFINED(
    specifier,
    packageJsonUrl && fileURLToPath$2(new URL(".", packageJsonUrl)),
    fileURLToPath$2(base)
  );
}
